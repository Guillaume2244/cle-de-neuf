...
c1 = CheckupItem.create!(name:"Pneus")
c2 = CheckupItem.create!(name:"Freinage")
c3 = CheckupItem.create!(name:"Revision")
c4 = CheckupItem.create!(name:"Balai essui glace")
c5 = CheckupItem.create!(name:"Catalyseur d'Echappement")
c6 = CheckupItem.create!(name:"Amortisseurs")
c7 = CheckupItem.create!(name:"Bougies")
c8 = CheckupItem.create!(name:"Climatisation")
c9 = CheckupItem.create!(name:"Controle Technique")
c10 = CheckupItem.create!(name:"Vidange")



ccc = Checkup.create!(book:b1, checkup_item:c1, km_ondate:"30000")

ccd = Checkup.create!(book:b2, checkup_item:c1, km_ondate:"30000")

d1 = Description.create!(name:"40 000km ou > 5 ans", numero: 1, checkup_item:CheckupItem.first)
d2 = Description.create!(name:"80 000km ou > 10 ans", numero: 2, checkup_item:CheckupItem.first)
d3 = Description.create!(name:"120 000km ou > 15 ans", numero: 3, checkup_item:CheckupItem.first)
d4 = Description.create!(name:"160 000km ou > 20 ans", numero: 4, checkup_item:CheckupItem.first)
